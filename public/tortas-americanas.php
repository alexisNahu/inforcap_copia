...
?>
    ...
    <div class="w-full mt-10">
        ...
        <div class="md:max-w-7xl grid grid-cols-2 mx-auto">
            <div class="w-full">
                <img src="./img/tortas-americanas.jpg" class="object-cover rounded-lg">
            </div>
            <div class="w-full">
                <div class="mx-auto md:mx-0">
                    <h2 class="text-base">Taller</h2>
                    <h1 class="font-petrona text-4xl text-bordoInforcap">TORTAS AMERICANAS</h1>
                </div>
                ...
                <ul class="text-base/loose">
                        <li>&rarr; TORTA RED VELVET </li>
                        <li>&rarr; CARROT CAKE</li>
                        <li>&rarr; TORTA BORWNIE</li>
