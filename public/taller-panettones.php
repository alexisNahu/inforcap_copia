    ...
    <div class="w-full mt-10 p-4">
        ...
        <div class="md:max-w-7xl grid grid-cols-1 md:grid-cols-2 gap-8 mx-auto">
            <div class="w-[400px] h-[400px] mr-10">
                <img src="img/panettones.jpg" class="object-cover rounded-lg">
            </div>
            <div class="w-full">
                <div class="mx-auto md:mx-0">
                    <h2 class="text-base">Taller práctico de 1 día</h2>
                    <h1 class="font-petrona text-4xl text-bordoInforcap">TALLER "PANETTONES Y SUS DERIVADOS"</h1>
                </div>
                <div class="md:flex my-10">
                    ...
                    <div class="px-6 border-r-2 border-amarilloInforcap">
                        ...
                        <p class="text-2xl font-petrona text-bordoInforcap">01/11/2025</p>
                    </div>
                    <div class="px-6 border-r-2 border-amarilloInforcap">
                ...
                <ul class="text-base/loose">
                        <li>&rarr; ELABORACIÓN DE PANETTONES CON FRUTAS + PASAS DE UVA + FRUTAS ABRILLANTADAS - SALVADO Y CHIP DE CHOCOLATE</li>
