    ...
    <div class="w-full mt-10 p-4">
        ...
        <div class="md:max-w-7xl grid grid-cols-1 md:grid-cols-2 gap-8 mx-auto">
            <div class="w-[400px] h-[400px] mr-10">
                <img src="img/reposteria-inicial.jpg" class="object-cover rounded-lg">
            </div>
            <div class="w-full">
                <div class="mx-auto md:mx-0">
                    <h2 class="text-base">Taller práctico de 1 día</h2>
                    <h1 class="font-petrona text-4xl text-bordoInforcap">TALLER "REPOSTERÍA INICIAL"</h1>
                </div>
                <div class="md:flex my-10">
                    ...
                    <div class="px-6 border-r-2 border-amarilloInforcap">
                        ...
                        <p class="text-2xl font-petrona text-bordoInforcap">Jueves</p>
                    </div>
                    <div class="px-6 border-r-2 border-amarilloInforcap">
                        <p class="text-base text-gris">Fecha</p>
                        <p class="text-2xl font-petrona text-bordoInforcap">27/11/2025</p>
                    </div>
                    <div class="px-6 border-r-2 border-amarilloInforcap">
                        <p class="text-base text-gris">Hora</p>
                        <p class="text-2xl font-petrona text-bordoInforcap">14:00 a 18:00</p>
                    </div>
                </div>

                <p class="text-2xl mb-6 text-bordoInforcap font-bold">Aprenderás a elaborar</p>
                <ul class="text-base/loose">
                        <li>&rarr; ELABORACIÓN DE BIZCOCHUELOS EN PLANCHAS.</li>
                        <li>&rarr; RELLENOS MUSES VARIOS, NUTELLA, GANACHE.</li>
                        <li>&rarr; DECORADOS CON CHANTILLY, CHOCOLATE, CEREZAS, FRUTOS SECOS.</li>
                        <li>&rarr; ARMADO Y MONTADO.</li>
                        <li>&rarr; PRESENTACIÓN.</li>
                        <li>&rarr; TRABAJO CON MANGAS.</li>
                        <li>&rarr; PRÁCTICA DE LETRAS. </li>
