...
?>
    ...
    <div class="w-full mt-10">
        ...
        <div class="md:max-w-7xl grid grid-cols-2 mx-auto">
            <div class="w-full">
                <img src="./img/panes-rusticos.jpg" class="object-cover rounded-lg">
            </div>
            <div class="w-full">
                <div class="mx-auto md:mx-0">
                    <h2 class="text-base">Taller</h2>
                    <h1 class="font-petrona text-4xl text-bordoInforcap">PANES RÚSTICOS</h1>
                </div>
                ...
                <ul class="text-base/loose">
                        <li>&rarr; ELABORACIÓN DE PAN CIABATTA </li>
                        <li>&rarr; FOCACCIA-BAGUETTE</li>
                        <li>&rarr; FOGAZA AL MOLDE</li>
