    ...
    <div class="w-full mt-10 p-4">
        ...
        <div class="md:max-w-7xl grid grid-cols-1 md:grid-cols-2 gap-8 mx-auto">
            <div class="w-[400px] h-[400px] mr-10">
                <img src="img/Heladeria-Industrial.jpg" class="object-cover rounded-lg">
            </div>
            <div class="w-full">
                <div class="mx-auto md:mx-0">
                    <h2 class="text-base">SEMINARIO</h2>
                    <h1 class="font-petrona text-4xl text-bordoInforcap">SEMINARIO DE "HELADERIA INDUSTRIAL"</h1>
                </div>
                ...
                <ul class="text-base/loose">
                        <li>&rarr; FORMULACIÓN Y ELABORACIÓN DE HELADOS ARTESANALES EJ - AMERICANA, CHOCOLATE, VAINILLA, COCO</li>
                        <li>&rarr; ELABORACIÓN DE CUCURUCHOS, PIONONOS Y TULIPAS.</li>
                        <li>&rarr; ELABORACIÓN DE TORTAS HELADAS Y POSTRES HELADOS A SER PRESENTADOS</li>
