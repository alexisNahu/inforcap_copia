        ...
        <div class="max-w-7xl text-center py-8 px-8 mx-auto">
            <div class="mt-10 mb-20 grid grid-cols-1 md:grid-cols-4 gap-4 text-left">
                ...
                <div class="rounded-md bg-slate-50 p-4 drop-shadow-xl"> 
                    <p class="mb-4 py-2 rounded-md"><span class="font-bold text-bordoInforcap">Requisitos</span></p>
                     ...
                     <div class="flex">
                        ...
                        <div class=""> 15 años cumplidos.</div>
                    </div>
                     <div class="flex">
                        <div class="mr-2 mb-2 text-amarilloInforcap">&#10003;</div>
                        <div class=""> Certificado de estudios visado por el M.E.C.</div>
                    </div>
                     <div class="flex">
                        <div class="mr-2 mb-2 text-amarilloInforcap">&#10003;</div>
                        <div class=""> Certificado de nacimiento.</div>
                    </div>
                     <div class="flex">
                        <div class="mr-2 mb-2 text-amarilloInforcap">&#10003;</div>
                        <div class=""> Dos fotocopias de cédula de identidad.</div>
                    </div>
                     <div class="flex">
                        <div class="mr-2 mb-2 text-amarilloInforcap">&#10003;</div>
                        <div class=""> Una foto tipo carnet.</div>
                    </div>
                     <div class="flex">
                        <div class="mr-2 mb-2 text-amarilloInforcap">&#10003;</div>
                ...
                <div class="rounded-md bg-slate-50 p-4 drop-shadow-xl"> 
                    ...
                    <div class="flex">
                        <div class="mr-2 mb-2 text-amarilloInforcap">&#10003;</div>
                        <div class=""> Masa Batida</div>
                    </div>
                    <div class="flex">
                        <div class="mr-2 mb-2 text-amarilloInforcap">&#10003;</div>
                        <div class=""> Masa Hojaldre</div>
                    </div>
                    <div class="flex">
                        <div class="mr-2 mb-2  text-amarilloInforcap">&#10003;</div>
                        <div class=""> Masa Quebrada (arenado método)</div>
                    </div>
                    <div class="flex">
                        <div class="mr-2 mb-2 text-amarilloInforcap">&#10003;</div>
                        <div class=""> Masa Para Freír</div>
                    </div>
                     <div class="flex">
                        <div class="mr-2 mb-2 text-amarilloInforcap">&#10003;</div>
                        <div class=""> Masa Bizcochuelo</div>
                    </div>
                    <div class="flex">
                        <div class="mr-2 mb-2 text-amarilloInforcap">&#10003;</div>
                        <div class=""> Merenges</div>
                    </div>
                </div>
            </div>
        </div>
