...
?>
    ...
    <div class="w-full mt-10">
        ...
        <div class="md:max-w-7xl grid grid-cols-2 mx-auto">
            <div class="w-full">
                <img src="./img/croissant.jpg" class="object-cover rounded-lg">
            </div>
            <div class="w-full">
                <div class="mx-auto md:mx-0">
                    <h2 class="text-base">Taller</h2>
                    <h1 class="font-petrona text-4xl text-bordoInforcap">CROISSANT</h1>
                </div>
                <div class="flex my-10">
                    ...
                    <div class="px-8">
                        ...
                        <div class="text-3xl font-petrona text-bordoInforcap">8</div>
                    </div>
                </div>

                <p class="text-2xl mb-6 text-bordoInforcap font-bold">Aprenderás a elaborar</p>
                <ul class="text-base/loose">
                        <li>&rarr; CROISSANT DE DIFERENTES RELLENOS: JAMON & QUESO, GUAYABA, CREMA PASTELERA, DULCE DE LECHE
QUESO CREMA, QUESO LIGTH</li>
                        <li>&rarr; CROISSANT DE CAFÉ Y CACAO</li>
                        <li>&rarr; COLORES VARIOS</li>
