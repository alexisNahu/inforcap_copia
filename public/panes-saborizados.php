...
?>
    ...
    <div class="w-full mt-10">
        ...
        <div class="md:max-w-7xl grid grid-cols-2 mx-auto">
            <div class="w-full">
                <img src="./img/panes-saborizados.jpg" class="object-cover rounded-lg">
            </div>
            <div class="w-full">
                <div class="mx-auto md:mx-0">
                    <h2 class="text-base">Taller</h2>
                    <h1 class="font-petrona text-4xl text-bordoInforcap">PANES SABORIZADOS</h1>
                </div>
                ...
                <ul class="text-base/loose">
                        <li>&rarr; ELABORACIÓN DE PAN DE QUESO</li>
                        <li>&rarr; ARROLLADOS DE JAMON Y QUESO</li>
                        <li>&rarr; PAN DE CEBOLLA</li>
                        <li>&rarr; PAN DE AJO </li>
                        <li>&rarr; PAN CON SALAME </li>
                        <li>&rarr; DEGUSTACIÓN</li>
