...
?>
    ...
    <div class="w-full mt-10">
        ...
        <div class="md:max-w-7xl grid grid-cols-2 mx-auto">
            <div class="w-full">
                <img src="./img/surtidos-de-empanadas.jpg" class="object-cover rounded-lg">
            </div>
            <div class="w-full">
                <div class="mx-auto md:mx-0">
                    <h2 class="text-base">Taller</h2>
                    <h1 class="font-petrona text-4xl text-bordoInforcap">SURTIDOS DE EMPANADAS</h1>
                </div>
                ...
                <ul class="text-base/loose">
                        <li>&rarr; ELABORACIÓN DE DISCOS FRITOS Y HORNEADOS</li>
                        <li>&rarr; RELLENOS VARIOS: CARNE, POLLO. JAMON Y QUESO, VERDURAS, CHILENA</li>
