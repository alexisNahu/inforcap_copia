...
?>
    ...
    <div class="w-full mt-10">
        ...
        <div class="md:max-w-7xl grid grid-cols-2 mx-auto">
            <div class="w-full">
                <img src="./img/galletitas-saborizadas.jpg" class="object-cover rounded-lg">
            </div>
            <div class="w-full">
                <div class="mx-auto md:mx-0">
                    <h2 class="text-base">Taller</h2>
                    <h1 class="font-petrona text-4xl text-bordoInforcap">GALLETITAS SABORIZADAS - CÉSAR DÍAZ</h1>
                </div>
                <div class="flex my-10">
                    ...
                    <div class="px-8 border-r-2 border-amarilloInforcap">
                        ...
                        <div class="text-3xl font-petrona text-bordoInforcap">20</div>
                    </div>
                    <div class="px-8">
                ...
                <ul class="text-base/loose">
                        <li>&rarr; GALLETITAS SABORES VARIOS (CAFÉ, LIMON, NARANJA, JENGIBRE)</li>
                        <li>&rarr; COBERTURA DE CHOCOLATE</li>
                        <li>&rarr; COOKIES DE CHOCOLATE, VAINILLA  Y RED VELVET</li>
