...
?>
    ...
    <div class="w-full mt-10">
        ...
        <div class="md:max-w-7xl grid grid-cols-2 mx-auto">
            <div class="w-full">
                <img src="./img/taller-de-lomipizzas.jpg" class="object-cover rounded-lg">
            </div>
            <div class="w-full">
                <div class="mx-auto md:mx-0">
                    <h2 class="text-base">Taller</h2>
                    <h1 class="font-petrona text-4xl text-bordoInforcap">TALLER DE LOMI PIZZAS Y HAMBURGUESAS GOURMET</h1>
                </div>
                <div class="flex my-10">
                    ...
                    <div class="px-8">
                        ...
                        <div class="text-xl font-petrona text-bordoInforcap">Desde: 08:00</div>
                        <div class="text-xl font-petrona text-bordoInforcap">Hasta: 12:00</div>
                    </div>
                </div>

                <p class="text-2xl mb-6 text-bordoInforcap font-bold">Aprenderás a elaborar</p>
                <ul class="text-base/loose">
                        <li>&rarr; ELABORACIÓN DE PAN VIENA TIPO PREPIZZA Y PAN VIENA HAMBURGUESA CON SEMILLAS</li>
                        <li>&rarr; MEDALLONES DE CARNE Y LOMITOS</li>
                        <li>&rarr; SALSA VARIAS LACTONESA, CRIOLLA Y CHOCLO</li>
                        <li>&rarr; CHEDDAR, QUESO CATUPIRY, LECHUGA REPOLLADA Y CEBOLLAS MORADAS</li>
