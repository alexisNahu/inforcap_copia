    ...
    <div class="w-full mt-10 p-4">
        ...
        <div class="md:max-w-7xl grid grid-cols-1 md:grid-cols-2 gap-8 mx-auto">
            <div class="w-[400px] h-[400px] mr-10">
                <img src="img/ABC-de-la-reposteria.jpg" class="object-cover rounded-lg">
            </div>
            <div class="w-full">
                <div class="mx-auto md:mx-0">
                    <h2 class="text-base">SEMINARIO</h2>
                    <h1 class="font-petrona text-4xl text-bordoInforcap">SEMINARIO "ABC DE LA REPOSTERÍA"</h1>
                </div>
                <div class="md:flex my-10">
                    ...
                    <div class="px-6 border-r-2 border-amarilloInforcap">
                        ...
                        <p class="text-2xl font-petrona text-bordoInforcap">09 - 23 - 30</p>
                    </div>
                    <div class="px-6 border-r-2 border-amarilloInforcap">
                ...
                <ul class="text-base/loose">
                        <li>&rarr; ELABORACIÓN DE BIZCOCHUELO EN PLANCHA, ARMADO, BATIDO, RELLENO, PRÁCTICA MANGA Y DECORACIÓN.</li>
                        <li>&rarr; ELABORACIÓN DE TORTAS FORRADAS A BASE DE PASTA AMERICANA - DISEÑOS VARIOS - PRESENTACIÓN</li>
                        <li>&rarr; ELABORACIÓN Y PRESENTACIÓN DE LOS ALUMNOS DE MINI TORTAS PARA EVENTOS A BASE DE BUTTERCREAM</li>
                ...
                <div class="mt-6">
                    ...
                    <!-- <strong>Frecuencia:</strong> 1 vez a la semana<br><br>-->
                     ...
                     <p class="my-8 text-2xl font-bold text-bordoInforcap"><span class="bg-naranjaInforcap text-white px-4 py-2 rounded-lg">Costo: Gs. 430.000</span></p>
                     <button class="bg-amarilloInforcap w-full py-4 uppercase hover:bg-naranjaInforcap text-white space-x-2 rounded-lg">
                    <span class="w-32"><i class="fa-brands fa-whatsapp"></i></span><a href="https://wa.me/595983350062" target="_blank">INSCRIBIRSE</a></button> 
                 </div>
            </div>
        </div>
