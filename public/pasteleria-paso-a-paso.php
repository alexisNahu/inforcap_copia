        ...
        <div class="md:max-w-7xl grid grid-cols-2 mx-auto">
            ...
            <div class="w-full">
                <div class="mx-auto md:mx-0">
                    ...
                    <h1 class="font-petrona text-4xl text-bordoInforcap">TALLER DE PASTELERÍA PASO A PASO</h1>
                </div>
                <div class="flex my-10">
                    ...
                    <div class="px-8 border-r-2 border-amarilloInforcap">
                        ...
                        <div class="text-3xl font-petrona text-bordoInforcap">1</div>
                    </div>
                    <div class="px-8">
                ...
                <ul class="text-base/loose">
                        ...
                        <li>&rarr; RELLENOS</li>
                        <li>&rarr; DECORADOS Y TRABAJOS CON MANGA</li>
