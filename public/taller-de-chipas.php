...
?>
    ...
    <div class="w-full mt-10">
        ...
        <div class="md:max-w-7xl grid grid-cols-2 mx-auto">
            <div class="w-full">
                <img src="./img/taller-de-chipas.jpg" class="object-cover rounded-lg">
            </div>
            <div class="w-full">
                <div class="mx-auto md:mx-0">
                    <h2 class="text-base">Taller</h2>
                    <h1 class="font-petrona text-4xl text-bordoInforcap">TALLER DE CHIPAS - CÉSAR DÍAZ</h1>
                </div>
                <div class="flex my-10">
                    ...
                    <div class="px-8 border-r-2 border-amarilloInforcap">
                        ...
                        <div class="text-3xl font-petrona text-bordoInforcap">27</div>
                    </div>
                    <div class="px-8">
                ...
                <ul class="text-base/loose">
                        <li>&rarr; ELABORACIÓN DE CHIPA TRADICIONAL</li>
                        <li>&rarr; CHIPA PIRU </li>
                        <li>&rarr; CHIPA PAQUITA </li>
                        <li>&rarr; CHIPA ASADOR </li>
                        <li>&rarr; CHIPA MESTIZO </li>
                        <li>&rarr; CHIPA SO´O.</li>
