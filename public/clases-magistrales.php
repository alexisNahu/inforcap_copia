    ...
    <div class="w-full bg-slate-50">
        <div class="max-w-7xl py-8 px-8 mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <div><img src="./img/magistrales-5.jpg"></div> 
                    <div><img src="./img/magistrales-6.jpg" alt=""></div>
              
          
                    <div><img src="./img/magistrales-11.jpg" alt=""></div>
                    ...
                    <div><img src="./img/magistrales-15.jpg" alt=""></div>
               
                    <div><img src="./img/magistrales-13.jpg" alt=""></div>
                    <div><img src="./img/magistrales-14.jpg" alt=""></div>
                    <div><img src="./img/magistrales-12.jpg" alt=""></div>

                    <div><img src="./img/magistrales-16.jpg" alt=""></div>
                    <div><img src="./img/magistrales-17.jpg" alt=""></div>
                    <div><img src="./img/magistrales-18.jpg" alt=""></div>
