    ...
    <div class="w-full">
        ...
        <div class="w-full md:max-w-7xl mx-auto mt-10 grid grid-cols-1 md:grid-cols-2">
            ...
            <div class="font-sacramento text-3xl text-bordoInforcap py-2 text-center md:text-right">
                ...
                Elige tu carrera, elige un futuro mejor.</span>
            </div>
        </div>
        ...
        <div class="md:max-w-7xl w-11/12 mx-auto mt-10 mb-20 md:pl-10">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
                ...
                <div class="md:w-4/5 md:mx-auto px-4 py-8 md:p-10 bg-amarilloInforcap rounded-lg h-full drop-shadow-xl">
                    <p class="text-2xl">Inscribite completando este formulario.</p>
                    <p class="mb-8">En breve nos pondremos en contacto contigo para realizar la suscripción.</p>
                    <div class="md:mr-2 mb-8">
                    ...
                    <div class="w-full mt-8 rounded-lg overflow-hidden bg-bordoInforcap">
                        <img src="https://images.pexels.com/photos/15587528/pexels-photo-15587528/free-photo-of-comida-azucar-postre-dulce.jpeg" class="object-cover w-full h-72">
                    </div>
                </div>
