...
?>
    ...
    <div class="w-full bg-slate-50">
        <div class="max-w-7xl py-8 px-8 mx-auto">
            ...
            <h1 class="text-3xl font-bold tracking-tight font-petrona text-bordoInforcap">Repostería y Decoración de Tortas </h1>
            <div class="text-xl tracking-tight text-gris mb-8">Aprenderá la técnica de pastillaje, artesanía en azúcar, en chocolate, torta forrada con fondant de distintos sabores (chocolate, vainilla, leche condensada, sabor chicle)<br> Presentación de torta gratinada con soplete, torta superpuesta,
                        decorado con merengue suizo, italiano, francés, merengue con y sin emulsionante.<br> Torta espejo, torta desnuda, torta helada, masa fina, chocolatería, petit fours, torta para todo tipo de eventos.</div>
            
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="md:col-span-2" id="galeriaCursos">
                    <div><img src="./img/decoracion-de-tortas-01.jpg"></div> 
                    <div><img src="./img/decoracion-de-tortas-02.jpg" alt=""></div>
                    <div><img src="./img/decoracion-de-tortas-03.jpg" alt=""></div>
                    <div><img src="./img/decoracion-de-tortas-04.jpg" alt=""></div>
                    <div><img src="./img/decoracion-de-tortas-05.jpg" alt=""></div>
                </div>
                
                <div class="md:relative w-full h-full bg-amarilloInforcap md:w-96 md:h-96">
                        <div class="md:absolute p-10 font-sacramento text-[28px] text-bordoInforcap text-left z-20">Conocé todas las técnicas  necesarias para convertirte en un profesional </div>
                </div>
        ...
        <div class="max-w-7xl text-center py-8 px-8 mx-auto">
            <div class="mt-10 mb-20 grid grid-cols-1 md:grid-cols-4 gap-4 text-left">
                ...
                <div class="rounded-md bg-slate-50 p-4 drop-shadow-xl"> 
                    ...
                    <p class="mb-4"><span class="font-bold">Sábados</span> de 14:00 a 18:00 hs.</p>
