    ...
    <div class="w-full mt-10 p-4">
        ...
        <div class="md:max-w-7xl grid grid-cols-1 md:grid-cols-2 gap-8 mx-auto">
            <div class="w-[400px] h-[400px] mr-10">
                <img src="img/cookies.jpg" class="object-cover rounded-lg">
            </div>
            <div class="w-full">
                <div class="mx-auto md:mx-0">
                    <h2 class="text-base">Taller práctico de 1 día</h2>
                    <h1 class="font-petrona text-4xl text-bordoInforcap">TALLER "COOKIES" CONVINACIÓN, TEXTURAS Y SABORES</h1>
                </div>
                ...
                <ul class="text-base/loose">
                        <li>&rarr; ELABORACIÓN DE COOKIES SURTIDOS - RED VELVET - CHOCOLATE - CAFÉ - VAINILLA</li>
                        <li>&rarr; RELLENOS FRUTAS - CREMAS Y TOPPINS VARIOS</li>
